...
export default function FamilyTreeVisual() {
  ...
  return (
    <div className="relative w-full h-[500px] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl p-8 overflow-hidden border-2 border-yellow-600/20 shadow-luxury">
